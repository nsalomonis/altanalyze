...
class MicroRNAClass:
    def __init__(self, exon_name, description, basepairs):
...
def remoteGene(gene,Species,root_dir,comparison_file):
    ...
    #for i in domain_color_key:  print(i, domain_color_key[i], "\n")
    ...
    for transcript in transcript_db:
        try:
            ...
            for entry in P_Domain_List:
                ...
                p_label = (str(entry[0]) +  " " + str(entry[1]))
                Repeat_Flag = 0
